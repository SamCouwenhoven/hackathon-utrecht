...
public class Drop extends ApplicationAdapter {
    ...
    public void create() {
        ...
        raindrops = new Array<Rectangle>(); // create array
        spawnRaindrop(); // spawn first drop
    }
    ...
    public void render() {
        ...
        if(bucket.x > 800 - 64) bucket.x = 800 - 64; // image is 64

        if(TimeUtils.nanoTime() - lastDropTime > 1000000000) spawnRaindrop();

        // iterating over all raindrops movingdownwards and removing if on the ground
